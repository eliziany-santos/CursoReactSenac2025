...
export default function Formulario(){
    ...
    async function Submit(evento:React.FormEvent<HTMLFormElement>){
        ...
        try{
            const respsta = await fetch(`${process.env.NEXT_PUBLIC_API_ROUTE}/`,{
                method: "POST",
                headers: {"Content-Type": "application/json"
                },
    ...
    return(
        <div>
            <form onSubmit={Submit}>
                <input onChange={(e) => setNome(e.target.value)} type="text" placeholder="Digite seu nome" name="nome"/>
                <input onChange={(e) => setEmail(e.target.value)} type="email" placeholder="Digite seu email" name="email"/>
